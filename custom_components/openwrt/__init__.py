        ...
        sources = [
            {
                ...
                CONF_SOURCE_NAME: entry.data.get(CONF_HOST, "OpenWrt"),
        ...
        try:
            ...
            for source, client in client_sources:
                ...
                for device in devices:
                    ...
                    merged["sources"].append(source.get(CONF_SOURCE_NAME, "OpenWrt"))
...
async def async_unload_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    """Unload an OpenWrt config entry."""
